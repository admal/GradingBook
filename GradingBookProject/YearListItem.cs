...
namespace GradingBookProject
{
    ...
    class YearListItem
    {
        ...
        /// <param name="_clickable">Determines wether an item should be clickable.</param>
        /// <param name="_owned">Determines wether a year belongs to a user currently viewing Main form.</param>
